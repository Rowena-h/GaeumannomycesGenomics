...
samtools sort ${out_dir}/${strain_file}_aln.bam -@ ${SLURM_CPUS_PER_TASK} -o ${out_dir}/${strain_file}_aln.sorted.bam
samtools index ${out_dir}/${strain_file}_aln.sorted.bam
