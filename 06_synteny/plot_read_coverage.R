...
feature(annoT.Gt14LH10.2B) <- 
              sub("Gt4e_EI_v1.1_ptg000005", "yellow",
                  sub("Gt4e_EI_v1.1_ptg000003", "orange",
                      genes.Gt14LH10.2B$block))
feature(annoT.Gt14LH10.3B) <- 
              sub("Gt4e_EI_v1.1_ptg000005", "yellow",
                  sub("Gt4e_EI_v1.1_ptg000003", "orange",
...
pdf(paste0("R://GaeumannomycesGenomics/06_synteny/Gh-1B17_translocation_coverage_5B_", Sys.Date(), ".pdf"),
    width=7, height=3.2)
plotTracks(list(gt.Gh1B17, annoT.Gh1B17.5B, at.Gh1B17.5B), from=3100000, to=4100000, sizes=c(1, 1, 6), title.width=0.5)
dev.off()

pdf(paste0("R://GaeumannomycesGenomics/06_synteny/Gh-1B17_translocation_coverage_1B.1_", Sys.Date(), ".pdf"),
    width=7, height=3.2)
plotTracks(list(gt.Gh1B17, annoT.Gh1B17.1B, at.Gh1B17.1B), from=400000, to=600000, sizes=c(1, 1, 6), title.width=0.5)
dev.off()

pdf(paste0("R://GaeumannomycesGenomics/06_synteny/Gh-1B17_translocation_coverage_1B.2_", Sys.Date(), ".pdf"),
    width=7, height=3.2)
plotTracks(list(gt.Gh1B17, annoT.Gh1B17.1B, at.Gh1B17.1B), from=4450000, to=4500000, sizes=c(1, 1, 6), title.width=0.5)
dev.off()
