...
~/programmes/table2asn/linux64.table2asn \
        -t ${out_dir}/${strain}_template.sbt \
        -locus-tag-prefix ${locus_tag} \
        -euk \
        -gaps-unknown 100 \
        -i ../scratch/CB-GENANNO-520_Mark_McMullan_Wheat_Take-all/Analysis/Gh-1B17/Reference/Genome/Gaeumannomyces_hyphopodioides_Gh-1B17_EI_v1.1_p_ctg.fa \
        -f ../scratch/CB-GENANNO-520_Mark_McMullan_Wheat_Take-all/Data_Package/Gh-1B17/Gh-1B17_EIv1.release.gff3 \
        -o ${out_dir}/old/${strain}.sqn \
        -M n -V b -Z
